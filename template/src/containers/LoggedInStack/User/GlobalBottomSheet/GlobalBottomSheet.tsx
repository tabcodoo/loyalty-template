...
const GlobalBottomSheetContainer = (props: any) => {
    ...
    let globalBottomSheet = useSelector((state) => state.globalBottomSheetNew);
    ...
    // console.tron.log('GlobalBottomSheetContainer new', globalBottomSheet);
        ...
        <>
            {globalBottomSheet.opened && (
                <Animatable.View animation={'fadeIn'} duration={500} style={styles.backDrop}>
                    <TouchableOpacity
                        style={{flex: 1}}
                        onPress={() => dispatch(actions.resetGlobalBottomSheetNew())}
                    />
                </Animatable.View>
            )}
            ...
            <BottomSheet
                ...
                onChange={(index) => {
                    if (!index) {
                        dispatch(actions.resetGlobalBottomSheetNew());
                    }
                }}
                // index={-1}
                // topInset={100}
