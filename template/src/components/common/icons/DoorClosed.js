...
<svg viewBox="0 0 19.091 17.498" xmlns="http://www.w3.org/2000/svg">
  <g id="room-service-icon" transform="matrix(1, 0, 0, 1, -683.372986, -1142.102051)">
    ...
    <path id="Rectangle_141" data-name="Rectangle 141" d="M7.254,0h0a7.254,7.254,0,0,1,7.254,7.254V9.017a0,0,0,0,1,0,0H0a0,0,0,0,1,0,0V7.254A7.254,7.254,0,0,1,7.254,0Z" transform="translate(685.665 1146.859)" fill="none" stroke-width="1.15" style="stroke: ${color};"/>
